...
CZCE_DAILY_URL = 'http://www.czce.com.cn/cn/DFSStaticFiles/Future/%s/%s/FutureDataDaily.txt'
CZCE_OPTION_URL = 'http://www.czce.com.cn/cn/DFSStaticFiles/Option/%s/%s/OptionDataDaily.txt'
